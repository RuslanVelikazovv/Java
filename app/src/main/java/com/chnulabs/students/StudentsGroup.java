...
public class StudentsGroup {
    ...
    private static ArrayList<StudentsGroup> groups = new ArrayList<StudentsGroup>(
            Arrays.asList(
                    new StudentsGroup("301","Компютерних наук", 0,true,false),

                    new StudentsGroup("302","Компютерних наук", 0,true,false),

                    new StudentsGroup("308","Компютерних наук", 0,true,true),

                    new StudentsGroup("309","Компютерних наук", 1,true,false),

                    new StudentsGroup("501m","Компютерних наук", 1,false,true)
            )
    );
